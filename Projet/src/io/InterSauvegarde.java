...
public interface InterSauvegarde {
  ...
  /**
   * Sauvegarde toutes les données de l'application : films, artistes,
  ...
  /**
   * Charge les données de l'application (films, artistes, évaluations,
   * utilisateurs...) à partir d'un fichier.
   *
