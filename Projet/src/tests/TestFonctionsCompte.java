...
public class TestFonctionsCompte {
    ...
    */
    ...
    /**
     * Verifie si le resultat de estConnecte est False si aucun utilisateur est connecté
     */
    @Test
    ...
    /**
     * Verifie si le retour de inscription est 1 a l’inscription d’un nouvel utilisateur
     */
    @Test
    void testInscription() {
    	InformationPersonnelle infoBasique = new InformationPersonnelle("Skywalker", "Luke");
    	assertEquals(fctCompte.inscription("pseudo1","mdp", infoBasique), 1);
    }
    
    /**
     * Verifie si le retour de inscription est 0 a l’inscription d’un utilisateur deja present (pseudo)
     */
    @Test
    ...
    /**
     * Verifie si l’utilisateur qui se connect est bien définit comme l’utilisateur connecté
     */
    @Test
    void tesConnextion() {
