...
/**
 * Représente un film avec ses attributs : genres, artistes, évaluations, 
 * titre, âge minimum, année de réalisation,
...
public class Film {
  ...
  /**
     ...
     * Initialise un film avec les genres, artistes, évaluations, 
     * location, année de réalisation, âge minimum et titre.
     *
     ...
     */
  public Film(Set<Genre> genre, Set<Artiste> setArtistes, 
      boolean location, int anneeReal, int ageMin, String titre) {
    // Utilise le paramètre ou crée un HashSet vide
    this.setGenre = genre != null ? genre : new HashSet<>();  
    // Idem pour les autres ensembles
    this.setArtistes = setArtistes != null ? setArtistes : new HashSet<>();  
  ...
  public Film(Set<Genre> setGenre, Set<Artiste> setArtistes, int anneeReal, int ageMin, String titre
    ...
    // Appelle le premier constructeur avec 'location' par défaut à false
    this(setGenre, setArtistes, false, anneeReal, ageMin, titre);  
  }
