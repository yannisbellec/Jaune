...
class TestFilm {
  ...
  */
  ...
  void setUp() throws Exception {
    ...
    artistes.add(new Artiste("Van damme", "Jean-claude", true));
  ...
  void testAjouterActeur() {
    Artiste acteur = new Artiste("Reichman", "Jean luc","quelconque");
    filmBasique.setActeur(acteur);
    assertTrue(filmBasique.getSetActeur().contains(acteur));
  }
